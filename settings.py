...
class Settings:
    ...
    def __init__(self, functions):
        ...
        decrease_len_btn = tk.Button(
            length_frame,
            image=self.decrease,
            command=lambda: self.change_value(value="length", change="decrease"),
            background=self.BG,
            border=0,
            cursor="hand2",
        )
        ...
        increase_len_btn = tk.Button(
            length_frame,
            image=self.increase,
            command=lambda: self.change_value(value="length", change="increase"),
            background=self.BG,
            border=0,
            cursor="hand2",
        )
        ...
        decrease_score_btn = tk.Button(
            score_frame,
            image=self.decrease,
            command=lambda: self.change_value(value="score", change="decrease"),
            background=self.BG,
            border=0,
            cursor="hand2",
        )
        ...
        increase_score_btn = tk.Button(
            score_frame,
            image=self.increase,
            command=lambda: self.change_value(value="score", change="increase"),
            background=self.BG,
            border=0,
            cursor="hand2",
        )
        ...
        self.change_word_length = tk.Button(
            self.window,
            text="Change",
